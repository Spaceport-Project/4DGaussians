...
def image_inference(yolo_predictor, sam_predictor, vis_folder, path, output_base_path, current_time, bg_image_path, erode_kernel, erode_iter):
...
def main(exp, args):
    ...
    if args.demo == "images":
        ...
        image_inference(predictor, sam_predictor, vis_folder, args.path, output_path, current_time, bg_image_path, erode_kernel, erode_iter)
